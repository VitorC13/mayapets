...
<div class="form-group">
    <label>${label}</label>
    <input class="form-control" maxlength="${maxlength}" ${putRequired} ${readonly} placeholder="${placeholder}" type="email" name="${id}" id="${id}" value="${valuex}" onkeypress="${onkeypress}" onfocus="${onfocus}" onblur="${onblur}" size="${size}" />
</div>