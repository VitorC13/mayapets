...
<div class="form-group">
    <label>${label}</label>
    <input class="form-control" ${putRequired} ${readonly} placeholder="${placeholder}" type="password" name="${id}" id="${id}" value="${valuex}" onkeypress="${onkeypress}" onfocus="${onfocus}" onblur="${onblur}" size="${size}" />
</div>