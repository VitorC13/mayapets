...
<fmt:message key='maya.table.product.name' var="column_name"/>
<fmt:message key='maya.table.product.cod.bar' var="column_codBar"/>
...
<div class="container-fluid">
    ...
    <main role="main" style="padding-top: 10px">
        ...
        <table id="report" class="stripe row-border table-responsive order-column">
            ...
            <tbody>
            <c:forEach var="list" items="${listproduct}" begin="0"
                       end="${listproductSize}">
                <tr>
...
<c:import url="/WEB-INF/jsp/product/modal/productForm.jsp"/>
