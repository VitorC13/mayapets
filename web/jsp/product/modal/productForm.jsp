    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">${title} Produto</h5>
            ...
            <div class="modal-body">
                <form action="Product">
                    ...
                    <fmt:message key='maya.table.product.name' var="name"/>
                    <fmt:message key='maya.table.product.type' var="type"/>

                    <maya:hidden id="txtId" valuex="${productEdit.id}"/>

                    <maya:character id="txtName" label="${name}" maxlength="255" required="true"
                                    valuex="${productEdit.name}" placeholder="${name}"/>

                    <maya:character id="txtType" label="${type}" maxlength="255" required="true"
                                    valuex="${productEdit.type}" placeholder="${type}"/>
